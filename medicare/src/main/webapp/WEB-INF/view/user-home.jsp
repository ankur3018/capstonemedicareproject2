			...
			<div style="margin-top: 7px;" class="col-lg-10 float-left">
				...
				<form action="searchProducts" method="POST">
					<div class=" input-group md-form form-sm form-2 pl-0 ">
						...
						<input name="keySearch" class="form-control my-0 py-1 red-border col-lg-12" type="text"
				...
				<a style="border-width: 0" type="submit" href="?sort=true">
							<span class="input-group-text red lighten-3" id="basic-text1"><i
								class="fa fa-sort text-grey" aria-hidden="true"></i></span>
						</a>
						</div>
				...
				<div id="cards_container" class="container">
					<div class="row">
						...
						<c:forEach var="product" items="${products}">
							...
							<div class="card col-xs-3"
								...
								<img class="card-img-top" src=${product.image_link} style="height : 8rem;width : 8rem;align-self:center">
								<div style="margin-left: auto; margin-right: auto;"
									class="card-body">
									<h5 class="card-title">${product.name}</h5>
									<p class="card-text">
										${product.company}<br>${product.size} Units<br>Rs ${product.price}
									</p>
					...
					<c:choose>
    					<c:when test="${empty products}">
       						<p style="width : 100%;text-align:center;margin-top : 20px">Sorry! no product found for your search</p>
   					 	</c:when>
