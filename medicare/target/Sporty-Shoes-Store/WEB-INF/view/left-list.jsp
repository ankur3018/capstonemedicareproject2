...
<div class="sidenav col-lg-2 d-flex flex-column h-100">
	<h4 id="logo">
		Medicare<br /><span style="font-size : 12px;">one stop for medicine</span>
	</h4>
	...
	<c:choose>
		<c:when test="${currentUser.type == 0 }">
			...
			<a class="nav-link active" id="sm"
				href="${pageContext.request.contextPath}/homepage/myorders"> <i
				class="fa fa-shopping-cart fa-sm"></i> My Orders
			</a> 
			<a class="nav-link" id="sm"
